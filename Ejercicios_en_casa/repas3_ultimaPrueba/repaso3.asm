;escibir dos numeros y sumarlos presentar en pantalla y que se guarde el resultado en un archivo
%macro imprimir 2
	mov eax, 4
	mov ebx, 1
	mov ecx, %1
...
section .data	
	...
	n2 db "   "
	suma db "   "
	archivo db "/home/calvita/Escritorio/PRUEBA_ENSAMBLADOR/archivo.txt", 0
